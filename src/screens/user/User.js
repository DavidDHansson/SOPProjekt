...
export default function User() {
    ...
    const tickets = [
        ...
        { type: "custom", title: "PHP", message: "Skræddersyet API'er og database til administration af brugere. Der er fokus på sikkerhed, kryptering, brugervenlighed og hastighed" }
    ]
